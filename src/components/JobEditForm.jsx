  ...
  return (
    <form onSubmit={handleSubmit} className={`grid gap-4 ${className}`}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div className="grid gap-2">
          <label htmlFor="salaryMin" className="text-sm font-medium">Minimalne wynagrodzenie</label>
          <input
            id="salaryMin"
            name="salaryMin"
            type="number"
        ...
        <div className="grid gap-2">
          <label htmlFor="salaryMax" className="text-sm font-medium">Maksymalne wynagrodzenie</label>
          <input
            id="salaryMax"
            name="salaryMax"
            type="number"
      ...
      <div className="grid gap-2">
        <label htmlFor="companyName" className="text-sm font-medium">Nazwa firmy</label>
        <input
          id="companyName"
          name="companyName"
          className={inputCls}
