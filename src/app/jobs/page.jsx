      ...
      <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-4">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className={`rounded-lg border px-2 py-2 text-sm ${currentRemote === "" ? "bg-brand-50 border-brand-600" : ""}`}
          >
            Wszystkie
          </Link>
          <Link
            href={setParam({ page: 1, remote: "1" })}
            className={`rounded-lg border px-2 py-2 text-sm ${currentRemote === "1" ? "bg-brand-50 border-brand-600" : ""}`}
          >
            Zdalnie
          </Link>
          <Link
            href={setParam({ page: 1, remote: "0" })}
            className={`rounded-lg border px-2 py-2 text-sm ${currentRemote === "0" ? "bg-brand-50 border-brand-600" : ""}`}
          >
            Stacjonarnie
          </Link>
        </div>
